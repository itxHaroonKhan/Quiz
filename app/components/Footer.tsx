      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center gap-4">
            <p className="text-sm" style={{ color: isDark ? "rgba(255,255,255,0.5)" : "rgba(30,41,59,0.5)" }}>
              © 2024 Quiz Master. Made with ❤️
            </p>
          </div>
          
          <div className="flex items-center gap-4">
            <a href="#" className="transition-colors hover:text-purple-400" style={{ color: isDark ? "rgba(255,255,255,0.5)" : "rgba(30,41,59,0.5)" }}>
          ...
          <div className="flex items-center gap-4 text-sm" style={{ color: isDark ? "rgba(255,255,255,0.5)" : "rgba(30,41,59,0.5)" }}>
